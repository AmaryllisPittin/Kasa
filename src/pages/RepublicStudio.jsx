...
const RepublicStudio = () => {
  const item = dataTab.find(item => item.id === "5323c29b");
  return (
    <div id="0">
        <Navigation />
        <div className="main">
            ...
            <div className="logement-page-presentation">
              <div className="title-and-location">
                ...
                <div className="logement-tags-container">
                  ...
                  <div className="logement-tag margin-tag">{item.tags[3]}</div>
                  <div className="logement-tag">{item.tags[4]}</div>
                </div>
              </div>
